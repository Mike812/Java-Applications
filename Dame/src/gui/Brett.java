...
public class Brett extends javax.swing.JFrame {
    ...
    public Brett() {
        ...
        for (int z = 0; z < feld.length; z++) {
            for (int sp = 0; sp < feld[z].length; sp++) {
                ...
                if (schwarz) {
                    if (z <= 3) {
                        f.setStein(new Einfach(f, false), true, false);
                    } else if (z >= 6) {
                        f.setStein(new Einfach(f, true), true, false);
                    }
                }
    ...
    public void merkeEnde(Stein stein, boolean geschlagen) {

        if (stein.getClass().getCanonicalName().equals("root.Einfach") || !geschlagen) {
    ...
    public boolean istOk(Stein stein, Feld ziel) {
        ...
        if (Math.abs(dx) > 1) {
            ...
            if ((stletzt = fletzt.getStein()) != null) {
    ...
    private class FeldListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (getZugbeginn()) {
                ...
                f.setStein(st, geschlagen);
                geschlagen=false;
            } else {
                st.getFeld().setStein(st, false);
                amZug = amZugMem;
            }
